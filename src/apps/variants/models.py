...
class QueryModel(models.Model):
    ...
    variant_ref = models.CharField(max_length=100, choices=VARIANTS_CHOICE, default='A')
    variant_alt = models.CharField(max_length=100, choices=VARIANTS_CHOICE, default='A')
